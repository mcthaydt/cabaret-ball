...
- `docs/input manager/input-manager-tasks.md` - **Start with Task 6.13 (performance)**
- `docs/input manager/general/phase-6-touchscreen-architecture.md` - Comprehensive patterns, critical findings
- `docs/input manager/input-manager-plan.md` - Phase 6 timeline
